...
const Header = () => {
  ...
  return (
    <div className="border-b-2 border-black w-full fixed top-0 left-0">
      <div className="md:px-10 py-4 px-7 md:flex justify-between items-center bg-white">
        ...
        <div className="flex w-10 h-10 m-2 absolute items-center right-16 top-6 cursor-pointer md:hidden">
          <UserCircleIcon />
        </div>
        <div
          onClick={() => setIsOpen((oldIsOpen) => !oldIsOpen)}
          className="flex w-10 h-10 m-2 absolute items-center right-8 top-6 cursor-pointer md:hidden"
        >
          <Bars3Icon />
        </div>
        <ul
